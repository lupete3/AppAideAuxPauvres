    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Ajouter une photo</li>
        </ol>
        <form action="../access/register_photo.php" method="POST" enctype="multipart/form-data">
       
        <!-- DataTables Example -->
       <div class="card card-register mx-auto mt-5">
      <div class="card-header text-uppercase">Ajouter une photo</div>
      <div class="card-body">
                 ...
                 <?php 
                   if (isset($_GET['sms']) AND $_GET['sms'] == 2){ ?>
                    <div class="alert alert-success alert-dismissible" id="msg" role="alert">
                            ...
                            <h6>Phot ajoutée avec succès</h6>
                          </div>
          ...
          <a href="listPhotos.php" title=""><button type="button" class="btn btn-sm btn-secondary "><i class="fa fa-list"></i> Afficher les photos</button></a>
              </div>
